...
*Inspired by the <b><code>447663⭐</code></b> <b><code>&nbsp;33684🍴</code></b> [awesome](https://github.com/sindresorhus/awesome)) list thing.*
...
* <b><code>&nbsp;&nbsp;&nbsp;243⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;28🍴</code></b> [decamelize](https://github.com/sindresorhus/decamelize)) - Convert a camelized string into a lowercased one with a custom separator: unicornRainbow → unicorn_rainbow.
...
* <b><code>&nbsp;&nbsp;&nbsp;505⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;44🍴</code></b> [strip-ansi](https://github.com/chalk/strip-ansi)) - Strip ANSI escape codes.
...
* <b><code>&nbsp;&nbsp;1211⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;66🍴</code></b> [pretty-ms](https://github.com/sindresorhus/pretty-ms)) - Convert milliseconds to a human readable string: 1337000000 → 15d 11h 23m 20s.
...
* <b><code>&nbsp;&nbsp;2075⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;123🍴</code></b> [fecha](https://github.com/taylorhakes/fecha)) - Javascript Date formatting and parsing.
...
* <b><code>&nbsp;&nbsp;5380⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;404🍴</code></b> [timeago.js](https://github.com/hustcc/timeago.js)) - A tiny(~1.7kb) library used to format date with `*** time ago` statement.
...
* <b><code>&nbsp;&nbsp;&nbsp;277⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;43🍴</code></b> [set-value](https://github.com/jonschlinkert/set-value)) - Create nested values and any intermediaries dot notation (`'a.b.c'`) paths.
* <b><code>&nbsp;&nbsp;&nbsp;294⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;22🍴</code></b> [get-value](https://github.com/jonschlinkert/get-value)) - Use property paths (a.b.c) to get a nested value from an object.
...
* <b><code>&nbsp;&nbsp;&nbsp;322⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;43🍴</code></b> [stringify-object](https://github.com/yeoman/stringify-object)) - Stringify an object/array like JSON.stringify just without all the double-quotes.
...
* <b><code>&nbsp;&nbsp;&nbsp;223⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;27🍴</code></b> [once](https://github.com/isaacs/once)) - Run a function exactly one time.
...
* <b><code>&nbsp;&nbsp;1152⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;54🍴</code></b> [mem](https://github.com/sindresorhus/mem)) - An optimization technique used to speed up consecutive function calls by caching the result of calls with identical input.
* <b><code>&nbsp;&nbsp;1049⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;106🍴</code></b> [throttle-debounce](https://github.com/niksy/throttle-debounce)) - Throttle/debounce your functions.
...
* <b><code>&nbsp;&nbsp;&nbsp;259⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;14🍴</code></b> [is-even](https://github.com/jonschlinkert/is-even)) - A good way to tell if a number is even or not (avoids type issues). Uses `is-odd` and `is-number` under the hood.
* <b><code>&nbsp;&nbsp;&nbsp;283⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;53🍴</code></b> [is-number](https://github.com/jonschlinkert/is-number)) - Returns `true` if the value is a number.
* <b><code>&nbsp;&nbsp;&nbsp;356⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;71🍴</code></b> [is-odd](https://github.com/jonschlinkert/is-odd)) - A good way to tell if a number is odd or not (avoids type issues). Uses `is-number` under the hood.
...
### Stream
* <b><code>&nbsp;&nbsp;1905⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;104🍴</code></b> [through2](https://github.com/rvagg/through2)) - Tiny wrapper around Node streams2 Transform to avoid explicit subclassing noise.
...
* <b><code>&nbsp;&nbsp;&nbsp;577⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;61🍴</code></b> [concat-stream](https://github.com/maxogden/concat-stream)) - writable stream that concatenates strings or data and calls a callback with the result.
* <b><code>&nbsp;&nbsp;1934⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;164🍴</code></b> [JSONStream](https://github.com/dominictarr/JSONStream)) - streaming JSON.parse and stringify
...
* <b><code>&nbsp;&nbsp;&nbsp;918⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;64🍴</code></b> [pump](https://github.com/mafintosh/pump)) - pipe streams together and close all of them if one of them closes.
...
* <b><code>&nbsp;&nbsp;1512⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;71🍴</code></b> [pify](https://github.com/sindresorhus/pify)) - Promisify a callback-style function.
...
* <b><code>&nbsp;&nbsp;5839⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;266🍴</code></b> [rimraf](https://github.com/isaacs/rimraf)) - A deep deletion module for node (like rm -rf).
...
* <b><code>&nbsp;&nbsp;&nbsp;771⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;98🍴</code></b> [tmp](https://github.com/raszi/node-tmp)) - Temporary file and directory creator for node.js.
...
* <b><code>&nbsp;&nbsp;&nbsp;187⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;25🍴</code></b> [delegate](https://github.com/zenorocha/delegate)) - Lightweight event delegation.
...
* <b><code>&nbsp;&nbsp;5406⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;567🍴</code></b> [semver](https://github.com/npm/node-semver)) - The semantic version parser used by npm.
...
* <b><code>&nbsp;&nbsp;8723⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;526🍴</code></b> [glob](https://github.com/isaacs/node-glob)) - Glob functionality for node.js.
...
* <b><code>&nbsp;&nbsp;&nbsp;176⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;&nbsp;24🍴</code></b> [png-to-ico](https://github.com/steambap/png-to-ico)) - Convert png to windows ico format.
...
* <b><code>&nbsp;15248⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;948🍴</code></b> [uuid](https://github.com/kelektiv/node-uuid)) - Generate RFC-compliant UUIDs in JavaScript.
* <b><code>&nbsp;&nbsp;2351⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;322🍴</code></b> [node-mime](https://github.com/broofa/node-mime)) - Comprehensive MIME type mapping API based on mime-db module.
...
* <b><code>&nbsp;26676⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;840🍴</code></b> [nanoid](https://github.com/ai/nanoid)) - A tiny (130 bytes), secure, URL-friendly, unique string ID generator for JavaScript
...
* <b><code>&nbsp;65367⭐</code></b> <b><code>&nbsp;&nbsp;6203🍴</code></b> [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs)) - A curated list of delightful Node.js packages and resources.
* <b><code>&nbsp;&nbsp;4688⭐</code></b> <b><code>&nbsp;&nbsp;&nbsp;275🍴</code></b> [awesome-npm](https://github.com/sindresorhus/awesome-npm)) - Awesome npm resources and tips.
